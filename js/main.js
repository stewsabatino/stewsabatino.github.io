...
$('button').addEventListener('submit', function(event) {
	...
	async function main() {
		...
		let info = await transporter.sendMail({
			from: '"Stew Sabatino" <stewsabatino@gmail.com>', // sender address
			to: `${'#email'}`, // list of receivers
			subject: "Stew Sabatino's Resume", // Subject line
			text: `Thank you ${'#name'}, for your interest in my resume! I have attached it to this email!`, // plain text body
			html: "<b>Hello world?</b>", // html body
			attachments: [
				{   // filename and content type is derived from path
					path: './images/Stew_Sabatino_Resume.pages'
				},
			]
		});
